...
axes.plot(times, adds, color='green', label='Addition', linewidth=0.1)
axes.plot(times, totals, color='red', label='Total', linewidth=0.1)
axes.plot(times, deletes, color='blue', label='Deletion', linewidth=0.1)
